...
// Source: gitlab.com/gitlab-org/cli/pkg/git (interfaces: GitInterface)
//
// Generated by this command:
//
//	mockgen -typed -destination=./git_interface_mock_for_test.go -package=git gitlab.com/gitlab-org/cli/pkg/git GitInterface
//
