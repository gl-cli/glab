	...
	testCases := []testCase{
		{
			...
			setupMock: func(tc *gitlabtesting.TestClient) {
				tc.MockMilestones.EXPECT().UpdateMilestone("456", 123, gomock.Any()).Return(testMilestone, nil, nil)
			},
		},
		{
	...
	testCases := []testCase{
		{
			...
			setupMock: func(tc *gitlabtesting.TestClient) {
				tc.MockGroupMilestones.EXPECT().UpdateGroupMilestone("456", 123, gomock.Any()).Return(testMilestone, nil, nil)
			},
		},
		{
