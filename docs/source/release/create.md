...
```plaintext
  ...
  -F, --notes-file file     Read release notes file. Specify `-` as the value to read from stdin.
  ...
  -D, --released-at date    The date when the release was ready. Defaults to the current datetime. Expects ISO 8601 format (2019-03-15T08:00:00Z).
```
